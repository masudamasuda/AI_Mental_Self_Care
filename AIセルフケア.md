...
２、瞑想とデフォルトモードネットワーク（DMN）の活性化、記憶の整理と統合
...
「Generative」はその場その場で新しい内容を生成する能力を指しています。つまり、ChatGPTはユーザーが話しかけるたびに、適切な返答や文章をその都度生成します。
...
9. 理想的な働き方（時間、場所、頻度、形態）はどのようなものですか？
...
認知行動療法（CBT）は、不安やうつ病などの精神疾患や日常的なストレス管理に効果が実証されている心理療法である。一方で、専門家による治療はコストが高く、また予約の取りにくさもあり、セルフケアとしてCBTを学び実践したいというニーズが高まっている。
...
、うまく使えないです。うまくセルフケアできません、マインドフルできません  
...
◆ 特徴  
	...
	•	認知行動療法と精神分析を併用するなど、技法の「架け橋」をつくる  
...
加えて霊的体験を構成するものとして、経験とは別に「思い込み」のような要素も必要でしょう。  
...
１５、あなたはメンタルコーチです。認知行動療法について私に解説してください。また具体例を出しつつ、私に体験させてください。私が返事に行き詰まった時は、私とあなたの会話が行き詰まらないように、あなたは様々な角度から私に質問をしてください。  
...
４１、あなたは高校教師です。人間の体について私に解説してください。私が返事に行き詰まった時は、私とあなたの会話が行き詰まらないように、あなたは様々な角度から私に質問をしてください。  
...
あなたはメンタルヘルスコーチです。  
ワーク001で学んだ「仕方がない、生まれてきてよかった」を踏まえて、  
私自身の「治癒した状態」のイメージを具体的に描く手伝いをしてください。
...
私が抽象的な答えをした場合は、より具体的に掘り下げてください。
...
もし途中で質問があれば、瞑想を中断して答えてください。  
初心者にも分かりやすい言葉を使ってください。
...
ーーープロンプト例ーーー  
これまでのあなたとの、私の自分語りの中で、私の主観が世界を解釈する時に置いている(私自身まだ気づいていないかもしれない)、強い仮定はなんですか？それを特定し、その仮定をひっくり返すとどのように世界の見え方、そして私の言動や行動がアップデートされるのか、いくつもの具体例を通して理解したいです。 

では、この古い仮定から新しい仮定へとアップデートを行うことで、私の日常生活（特に職場とプライベートそれぞれの近しい人との人間関係）において、具体的にどのように言動や行動が変化するのでしょうか？ あなたが私について知っていることを元に、私がよく直面するような５つの状況を小説風に想像し、「状況の描写」、「古い仮定による解釈、言動、行動」、「 新しい仮定による解釈、言動、行動」を詳細に記述することで、それぞれの場面において私の行動や振る舞いがどのように変化するかを詳細も含め書いてください。

パーソナル哲学獲得のための地獄めぐり一覧（自己理解と問題解決）  
、準備：マインドフルネス、プロンプトの書き方など  
、自分史および家族史、現代史  
、社会問題、ライフステージ別にも  
、抽象概念の言語化  
、代表的精神療法  
、精神医学〜脳神経科学  
、人文系学問：歴史、宗教史、哲学や倫理、文学思想  
、理系学問：科学、数学、科学哲学、統計学、論理学、AIなど  
、陰謀論や民間療法への傾倒に注意
